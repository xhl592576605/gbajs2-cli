import { MemoryView, MemoryBlock } from './memory.js';
import { Serializer } from './util.js';
import GameBoyAdvanceGPIO from './gpio.js';
import { SRAMSavedata, FlashSavedata, EEPROMSavedata } from './savedata.js';
			...
			case this.DMA_TIMING_CUSTOM:
				switch (number) {
					...
					case 3:
						...
						this.cpu.irq.video.scheduleVCaptureDma(undefined, info);
						break;
				}
		}
	}
